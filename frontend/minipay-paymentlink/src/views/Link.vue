...
onMounted (async() => {
  ...
  provider.value = new Web3.providers.HttpProvider('https://alfajores-forno.celo-testnet.org');
...
//   console.log(accounts)
  ...
  const link_id = web3.eth.abi.encodeParameter('uint256',userId)
  link.value = await contract.value.methods.getPaymentLink(link_id).call();
...
<template>
<h1 class="py-6">Make the payment on Celo</h1>
<h4>Payments are safe and secure</h4>
<h2>{{ link.amount }} USD</h2>
<v-col class="my-4">
<QRCodeVue3 
v-if="isLoading"
:value=link.recipient
:width="300"
:height="300"
/>
</v-col>
