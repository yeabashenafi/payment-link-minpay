...
onMounted (async() => {
  ...
  const provider = new Web3.providers.HttpProvider('https://alfajores-forno.celo.org');
  ...
  console.log("Successfully connected with the contract:",contract);

  // calling a contract method
  paymentLink = await contract.methods.createPaymentLink("0x6eE165CD887334cf5a2eA2E62223de4Be482cf24","0x6eE165CD887334cf5a2eA2E62223de4Be482cf24",100,"Hello").call();
...
<template>
  ...
  <div class="card">
    <button type="button" @click="count++">connect</button>
    <p>
